    ...
    descriptions = {
        Joker = {
            ...
            j_grace_mime = {
                name = "Mime",
                text = {
                    "This joker gives {C:chips}+300{} Chips.",
                    "{X:mult,C:white}DO NOT SELL.{}"
                }
            },
            j_grace_worship = {
                name = " ",
            ...
            j_grace_sorrow = {
                name = "Sorrow",
                text = {
                    "Takes {C:chips}100{} Chips and {C:mult}8{} Mult",
            ...
            j_grace_litany = {
                name = "Litany",
                text = {
                    "Im {C:money}JUDGING{} {C:attention}YOU{} {C:red}FOOL{}"
                }
            },
            j_grace_ire = {
                name = "Ire",
            ...
            j_grace_dozer = {
                name = "Dozer",
                text = {
                    "Im the {C:red}King{} of {C:money}Yellow{}"
                }
            },
            j_grace_pointy = {
                name = "Pointy",
